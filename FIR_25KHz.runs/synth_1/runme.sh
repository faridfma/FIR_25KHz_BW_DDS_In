...
HD_PWD='C:/Users/fmabrouk/Downloads/FIR_12K5_DDS-master/FIR_25KHz_DDS-master/FIR_25KHz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_TopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_TopLevel.tcl
