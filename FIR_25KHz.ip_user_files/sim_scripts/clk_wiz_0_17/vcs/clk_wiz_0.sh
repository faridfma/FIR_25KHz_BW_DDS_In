...
#
# Generated by Vivado on Tue Dec 16 12:13:10 -0800 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../../../FPGA/FIR_SysGen/SysGenIP/ip/clk_wiz_0_17/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../../../FPGA/FIR_SysGen/SysGenIP/ip/clk_wiz_0_17/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
